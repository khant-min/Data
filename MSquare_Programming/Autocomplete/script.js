...
const navigateAndSelectProduct = key => {
  if (key === "ArrowDown") {
    ...
    const enteredProduct = filteredProducts[indexToSelect];
    ...
    textNode.style.marginBottom = "16px";
    textNode.append("You have been selected this item...");

    const imageInfo = document.createElement("div");
    imageInfo.classList.add("imageInfo");

    const purchasedDescription = document.createElement("div");
    purchasedDescription.classList.add("purchaseDescription");
    purchasedDescription.append(enteredProduct.description);

    const chosenImage = document.createElement("img");
    chosenImage.classList.add("chosenImage");
    chosenImage.src = enteredProduct.image;
    imageInfo.append(purchasedDescription, chosenImage);

    const nextInfo = document.createElement("div");
    nextInfo.classList.add("nextInfo");
    const text = document.createElement("div");
    text.style.textAlign = "center";
    text.style.borderBottom = "1px solid black";
    text.append("Product Info");
    const rating = document.createElement("div");
    rating.append(`rating :  ${enteredProduct.rating.rate}`);
    const count = document.createElement("div");
    count.append(`count : ${enteredProduct.rating.count}`);
    const price = document.createElement("div");
    price.append(`price : ${enteredProduct.rating.rate}$`);
    nextInfo.append(text, rating, count, price);

    const lastTextNode = document.createElement("div");
    lastTextNode.classList.add("last");
    lastTextNode.append("Thanks for your purchased!");

    newDiv.append(textNode, imageInfo, nextInfo, lastTextNode);
